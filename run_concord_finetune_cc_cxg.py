    ...
    def __getitem__(self, i):   
        ...
        while True:
            ...
            if shuffle_example.index!=index:
                ...
                break
        # Note: We take this implementation directly from CodeXGLUE, and the randomness
        # below generate different set of samples during training and evaluation (after reloading the best model)
        # Therefore, we will see different "eval" results during training and evaluation. But the test results are stable.
